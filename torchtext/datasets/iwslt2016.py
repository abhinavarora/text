...
def IWSLT2016(
    ...
    **valid/test sets**: ['dev2010', 'tst2010', 'tst2011', 'tst2012', 'tst2013', 'tst2014']
    ...
    """
    num_lines_set_identifier = {"train": "train", "valid": valid_set, "test": test_set}
    ...
    valid_filenames = (
        "IWSLT{}.TED.{}.{}-{}.{}".format(
            SUPPORTED_DATASETS["year"], valid_set, src_language, tgt_language, src_language
        ),
        "IWSLT{}.TED.{}.{}-{}.{}".format(
            SUPPORTED_DATASETS["year"], valid_set, src_language, tgt_language, tgt_language
        ),
    )
    test_filenames = (
        "IWSLT{}.TED.{}.{}-{}.{}".format(
            SUPPORTED_DATASETS["year"], test_set, src_language, tgt_language, src_language
        ),
        "IWSLT{}.TED.{}.{}-{}.{}".format(
            SUPPORTED_DATASETS["year"], test_set, src_language, tgt_language, tgt_language
        ),
    )
    ...
    dataset_tar = download_from_url(
        SUPPORTED_DATASETS["URL"],
        root=root,
        hash_value=SUPPORTED_DATASETS["MD5"],
        path=os.path.join(root, SUPPORTED_DATASETS["_PATH"]),
        hash_type="md5",
    )
    ...
    iwslt_tar = "{}/{}/texts/{}/{}/{}.tgz"
    iwslt_tar = iwslt_tar.format(root, SUPPORTED_DATASETS["_PATH"].split(".")[0], src_language, tgt_language, languages)
    ...
    return _RawTextIterableDataset(
        DATASET_NAME,
        NUM_LINES[split][num_lines_set_identifier[split]][tuple(sorted(language_pair))],
